...
@Service
public class JwtUlti implements Serializable {
    private static Logger logger = LoggerFactory.getLogger(JwtUlti.class);
...
//            throw new JwtException("ExpiredJwtException");
    ...
    private Claims extractAllClaims(String token) {
        try {
            logger.info(String.valueOf(Jwts.parser().setSigningKey(SECRET_KEY).parseClaimsJws(token).getBody()));
